# =====================================================
# Programmer DarkMeArk
# Darkmeark X Bitcoin (CPU SAVER MOD) 
# DONATE (BTC) : bc1qx7h64wkfxrslycpv74v0700fu2dqflh4s3e77x
# Github.Com/DarkMeArk
# =====================================================
...
def process(data):
    private_key = data[0]
    address = data[1]
    urlblock = "https://keys.lol/bitcoin(address)
